...
scrapegoat is a small library for building powerful website scrapers, using a declarative, functional approach.
...
- Read more about the [concepts used within scapegoat](./overview/concepts)
- Learn how to use scrapegoat by [building a scraper with it](./tutorial/blog)
- Check how to use the provided methods in the [API reference](./api)
- If you just want to get started, [install scrapegoat into your project](./install/from-npm)
