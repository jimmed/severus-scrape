...
To achieve this, scrapegoat uses the following concepts:
...
You can define a scraper for a site by combining these concepts, using methods provided by scrapegoat. 
